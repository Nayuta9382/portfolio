...
export default function Home() {
  ...
  return (  
    ...
    <WorksPageItemLayout htmlId={navData[0].id} title={navData[0].name}>
        <Text>
          &emsp;2・3年生での共同開発で「一人暮らしを助け合う」をテーマにWEBアプリケーションを開発することになりました。
          チームでの開発の中で生活の知恵などが知ることが出来る機能が発案されました。
          その案をもとに、「ひとり暮らしで役に立った知識、悩みや不安などを共有しあうことが出来るようなアプリ」という意見が出ました。
          これらをもとにひとりぐらしの方々が助け合えるために知識や知恵、悩みなどをみんなが閲覧でき、共有できるアプリを開発しました。
        </Text>
      </WorksPageItemLayout>
