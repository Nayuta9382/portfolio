...
const TopMenuItem: FC<TopMenuItemProps> = ({link,src, alt = '', title}) => {
    return (
        <Link href={link} className="flex items-center overflow-hidden relative  rounded-[20px] shadow-rb w-[80%] ss:w-[70%] md:w-1/4 max-h-[48vw] ss:h-[40vw]  md:h-auto  min-w-[250px]  sm:min-w-0 min-h-[180px]  ss:min-h-0 hover:opacity-90 active:opacity-80">
