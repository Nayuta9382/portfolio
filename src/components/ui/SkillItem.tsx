...
const SkillItem: FC<SkillItemProps> = ({imgName, alt, name, smName, starCount}) => {
    ...
    return (
        <div className="flex gap-x-[3%] w-[42%]  ss:w-[42%] sm:w-2/5 md:w-[40%] lg:w-[26%]  min-w-[122px] h-[15vw] sm:h-[13vw] md:h-[9vw] min-h-14 pb-1.5 ss:pb-[2px] sm:pb-0 border-b-2 border-black">
