...
const NavButton:FC<NavButtonProps> = ({right,openNavFlg,setOpenNavFlg}) => {
     // Navメニューのホバー情報を格納する
    ...
    return (
        <button style={style} type="button" onClick={menuOnClose}  onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)} className=" w-9 sm:w-11 lg:w-[50px] pt-3 pb-4 sm:rounded-l-[px]5 rounded-l-[10px] bg-[#372A28] fixed top-[10%]  hover:opacity-90  active:opacity-80">
