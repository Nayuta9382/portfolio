...
const WorksTopView: FC<WorksTopViewProps> = ({title,text,imgPath}) => {
    return (
        <div className=" mb-2 sm:mb-3 md:mb-5">
            ...
            <Image className="block w-full h-[25vh] min-h-[200px] sm:h-auto object-cover mt-4 lg:mt-7 border-[1.5px] border-[#838181] border-opacity-40 rounded-[10px]" src={imgPath} alt={imgPath} width={100} height={100}  unoptimized={true}  quality={100}   priority  />
        </div>
    );
}
